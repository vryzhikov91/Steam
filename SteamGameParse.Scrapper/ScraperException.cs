...
namespace SteamGameParse.Scrapper
{
    public class ScraperException : Exception
    {
        ...
        public ScraperException(string message, IStoreScraper scraper, Exception innerException, string appId = null, 
            string url = null, int? statusCode = null) : base(message, innerException)
        {
